<template>
    <div>
                <div class="card-container">
                     <router-link :to="{name: 'product.detail', params: {bookId: product.BookId, productId: product.id  }, query: {bookId: product.BookId, productId: product.id}}">
                        <div class="card">                       
                            <div class="card-content">
                                ...
                                <p class="card-price"><b-tag type="is-warning" style="font-size: 1.2em; display: block; width: 120px; margin: 0 auto; text-align:center; padding: 0.2em;">${{ product.price }}</b-tag></p>
                            </div>
